  ...
  <body class="bg-gray-100">
    ...
    >
      <div class="container-fluid ">
        <a class="navbar-brand" href="#">
          ...
          <b class="font-serif text-black "></b>
        </a>
        <div class="font-serif " id="navbarSupportedContent">
          <ul class="mr-auto navbar-nav ">
            <li  class="nav-black active">
            ...
            <li class="nav-item active">
              <a href="logout" class="text-black font-bold nav-link d-none d-sm-none d-md-none d-lg-inline-block d-xl-inline-block" >Logout <span class="sr-only">(current)</span></a>
            
            </li>
            <li class="nav-item active">
              <a  href="#sidebar" class="text-black d-none d-lg-none d-xl-none d-sm-inline-block d-md-inline-block d-lg-inline-block d-xl-inline-block " data-bs-toggle="offcanvas"
    ...
    <div class="offcanvas offcanvas-top bg-gradient-to-r from-teal-800 to-orange-100 " tabindex="-1" id="sidebar" aria-labelledby="sidebar-label">
      <div class="offcanvas-header">
        <h5 class="font-serif font-bold text-white offcanvas-title" id="sidebar-label">Menu</h5>
      </div>
      ...
      <div class="offcanvas-body">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-6">
              ...
              <a href="login" class="text-white nav-link d-none d-sm-none d-md-none d-lg-inline-block d-xl-inline-block" >Logout <span class="sr-only">(current)</span></a>
    ...
    <div class="flex ">
      <div id="sidebarr"class="sidebarr "">
        <span class="absolute left-0 text-2xl text-black cursor-pointer top-13" onclick="Open()">
        ...
        <div style="background-color: #96BBBB"
          ...
          <div class="text-xl text-black ">
            <div class="p-2.5 mt-1 flex items-center">
              ...
              <h1 class="font-bold text-[15px] ml-3 text-black"> Home Page </h1>
            ...
            <div
              class="flex p-2.5 cursor-pointer hover:bg-teal-800 mt-3 items-center rounded-md px-4 duration-300 font-bold">
              <a class="text-[15px] ml-2 text-black" href="/transport">Manage Transport</a>
            </div>
            <hr class="my-2 text-gray-600">
            <div
              class="flex p-2.5 cursor-pointer hover:bg-teal-800 mt-3 items-center rounded-md px-4 duration-300 font-bold">
              <a class="text-[15px] ml-2 text-black" href="/schedule">Manage Schedule</a>
            </div>
            <hr class="my-2 text-gray-600">
            <div
            class="flex p-2.5 cursor-pointer hover:bg-teal-800 mt-3 items-center rounded-md px-4 duration-300 font-bold">
            <a class="text-[15px] ml-2 text-black" href="/location">Manage Locations</a>
          </div>
          <hr class="my-2 text-gray-600">
          <div
          class="flex p-2.5 cursor-pointer hover:bg-teal-800 mt-3 items-center rounded-md px-4 duration-300 font-bold">
          <a class="text-[15px] ml-2 text-black" href="/reservation">View Reservations</a>
        </div>
          <hr class="my-2 text-gray-600">
            <div
              class="flex p-2.5 cursor-pointer hover:bg-teal-800 mt-3 items-center rounded-md px-4 duration-300 font-bold">
              <a class="text-[15px] ml-2 text-black" href="/search"> View Schedule</a>
            </div>
            <hr class="my-2 text-gray-600">
            <div class="flex p-2.5 cursor-pointer mt-3 items-center rounded-md px-4 duration-300 hover:bg-teal-800 hover:text-white font-bold">
              <a class="text-[15px] ml-2 text-black" href="/booking">View Bookings</a>
          </div>
          <hr class="my-2 text-gray-600">
            <div 
            class="flex p-2.5 cursor-pointer hover:bg-teal-800  mt-3 items-center rounded-md px-4 duration-300 font-bold">
            <a class="text-[15px] ml-2 text-black" href="/payment">Manage Payments</a>
          </div>
