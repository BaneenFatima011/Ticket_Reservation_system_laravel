...
<div class="container mx-auto mt-8">
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg">
        ...
        <form action="{{ route('reservationAdmin.index2') }}" method="GET" class="mb-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div style="background-color:#C19875" class=" text-black shadow-md rounded px-8 pt-2 pb-2 w-full "> <!-- Adjusted max width -->
                <h2 class="text-center text-xl font-bold mb-6"></h2>
            </div>
            <div class="border border-gray-200 p-4 mb-4 rounded-lg flex flex-wrap">
                <div class="w-1/2 pr-4">
                    ...
                    <p><span class="font-semibold">Company Name:</span> {{ $result->transport->company->company_name}}</p>
                    <p><span class="font-semibold">Model:</span> {{ $result->transport->model}}</p>
                ...
                <div class="w-1/2 pl-4">
                    ...
                    <p><span class="font-semibold">Passenger Name:</span> {{ $result->reservations->passenger->name }}</p>
                    <p><span class="font-semibold">Payment Status:</span> {{ $result->reservations->status}}</p>
                    <p><span class="font-semibold">Passenger Id:</span> {{ $result->reservations->passenger->passenger_id}}</p>
                    <p><span class="font-semibold">Seat Id:</span> {{ $result->reservations->seat->seat_id}}</p>
                </div>
            </div>
